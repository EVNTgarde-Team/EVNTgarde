          ...
          <div className="container px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between">
                <Button variant="outline" className="w-1/2 mr-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-semibold rounded-lg py-2">
                  Reset
                </Button>
