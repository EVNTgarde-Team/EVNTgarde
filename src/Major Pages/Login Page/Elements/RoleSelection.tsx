  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-300 font-[Poppins]">
      <div className="flex w-[1440px] h-[650px] bg-blue-600 rounded-xl shadow-lg overflow-hidden">
        ...
        >
          <h2 className={`text-4xl font-bold ${isDarkMode ? "text-white" : "text-gray-800"} mb-6`}>Sign Up</h2>

          <div className="mb-6">
            <p className={`text-lg ${isDarkMode ? "text-white" : "text-gray-700"}`}>What brings you here today?</p>
          ...
          <div className="space-y-4 mb-8">
            ...
            >
              ...
              />
              <div>
                <p className="font-medium">I'm planning an event and need help organizing it</p>
              </div>
            </label>
            ...
            >
              ...
              />
              <div>
                <p className="font-medium">I'm an event organizer looking for vendors and suppliers</p>
              </div>
            </label>
            ...
            >
              ...
              />
              <div>
                <p className="font-medium">I'm a vendor looking to market my business</p>
              </div>
            </label>
          </div>
