  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-300 font-[Poppins]">
      <div className="flex w-[1440px] h-[650px] bg-blue-600 rounded-xl shadow-lg overflow-hidden font-poppins">
        ...
        <div
          className={`w-3/5 ${isDarkMode ? "bg-gray-800" : "bg-white"} p-10 flex flex-col justify-center rounded-l-[50px] shadow-md`}
        >
          ...
          <form className="flex flex-col space-y-4" onSubmit={handleLogin}>
            ...
            <input
              type="email"
              placeholder="Email"
              className={`border p-3 rounded-md ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-800"}`}
              value={email}
            ...
            <div className="relative">
              <input
                ...
                className={`border p-3 w-full rounded-md ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-800"}`}
                value={password}
